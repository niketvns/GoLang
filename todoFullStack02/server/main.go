...
func main() {
	...
	if os.Getenv("ENV") != "production" {
		// Load the .env file in dev mode only because on productin, we do not have .env file
		err := godotenv.Load()
	...
	// We not need cors setup on production because both FE and BE will be on the same route
	// app.Use(cors.New())
